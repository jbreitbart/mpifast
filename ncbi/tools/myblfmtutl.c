static char const rcsid[] = "$Id: blfmtutl.c,v 1.37 2009/02/02 21:37:55 camacho Exp $";
...
#define BLAST_ENGINE_VERSION "2.2.20"
#define BLAST_RELEASE_DATE "Feb-08-2009"
...
#ifdef MPIBLAST_PIO
		/* pio*/
		intercept_output_tabular(INT_ALN_TAG);
#endif
