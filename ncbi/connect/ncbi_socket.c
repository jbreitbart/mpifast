...
#  endif /*NCBI_OS_LINUX*/
/* mpiBLAST specific <<<<< */
#  if !defined(NCBI_OS_BEOS) && !defined(ARCH_BGL) && !defined(ARCH_BGP)
/* mpiBLAST specific >>>>> */
#    include <arpa/inet.h>
#  endif /*NCBI_OS_BEOS*/
#  include <signal.h>
...
{
/* mpiBLAST specific <<<<< */
#if (defined(NCBI_OS_UNIX)  ||  defined(NCBI_OS_MSWIN)) && !defined(ARCH_BGL) && !defined(ARCH_BGP)
/* mpiBLAST specific >>>>> */
...
/* mpiBLAST specific <<<<< */
#if ((defined(NCBI_OS_UNIX) && !defined(NCBI_OS_BEOS)) || defined(NCBI_OS_MSWIN)) && !defined(ARCH_BGL) && !defined(ARCH_BGP)
/* mpiBLAST specific >>>>> */
